...
const Hero = () => {
  return (
    <>
      <section
        className="h-screen flex flex-col justify-center items-center text-center bg-gray-950 text-white"
        id="home"
      >
        <h1
        ...
        <button
          className="mt-6 bg-blue-500 px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors duration-300 cursor-pointer"
          data-aos="fade-up"
          data-aos-delay="400"
